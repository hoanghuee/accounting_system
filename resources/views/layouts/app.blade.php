        ...
        <div style="padding-top:81px" class="d-flex align-items-stretch">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled">
                    ...
                    <li {{ activeIfRoute('mathang.create') }}><a href="{{ route('mathang.create') }}"> <i class="fa fa-file-text-o"></i>Quản lý Mặt hàng</a></li>

                    <li {{ activeIfRoute('adjustments.create') }}><a href="{{ route('adjustments.create') }}"> <i class="icon-padnote"></i>Bảng Chấm công</a></li>
                    <li {{ activeIfRoute(['chartaccounts.create','accounts.create'])}}>
                        ...
                        <ul id="Accounts" class="collapse list-unstyled ">
                            <li {{ activeIfRoute('chartaccounts.create') }}><a href="{{ route('chartaccounts.create') }}">Bảng Chấm công</a></li>
                            <li {{ activeIfRoute('accounts.create') }}><a href="{{ route('accounts.create') }}">Bảng Lương</a></li>
                        </ul>
                    </li>
